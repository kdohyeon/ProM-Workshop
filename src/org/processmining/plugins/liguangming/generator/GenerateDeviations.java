...
public class GenerateDeviations {

	public XLog generateDeviation(XLog Log,double deviationProbability,int deviationType) 
	{
...
//			changeMap.put(eventClass.toString(), changeEventName[n]);
		...
		for (int i = 0; i <= deviationProbability*Log.size()-1; i++) 
		{
